    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = await this.userService.GetUserByUsernameAsync(Input.Username);
                if (user?.Ban >= DateTime.UtcNow)
                {
                    ModelState.AddModelError(string.Empty, ErrorConstants.Invalid_Banned_User_Login_Attempt);
                    return this.Page();
                }
